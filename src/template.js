<>
  <title>Hệ Thống Liên Lạc Trực Tuyến - IUH</title>
  <link rel="shortcut icon" href="https://lms.iuh.edu.vn/theme/image.php/academi/theme/1600662090/favicon" />
  <meta httpEquiv="Content-Type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="moodle, Hệ Thống Liên Lạc Trực Tuyến - IUH" />
  <link rel="stylesheet" type="text/css" href="https://lms.iuh.edu.vn/theme/yui_combo.php?rollup/3.17.2/yui-moodlesimple-min.css" />
  <link rel="stylesheet" type="text/css" href="https://lms.iuh.edu.vn/theme/styles.php/academi/1600662090_1/all" />
  ...
  <div id="page" className="container">
    <header id="page-header" className="clearfix">
      <a title="Trang chủ" className="logo" href="https://lms.iuh.edu.vn" />        <div id="page-navbar" className="clearfix">
        <nav className="breadcrumb-nav"><nav role="navigation" aria-label="Breadcrumb trail">
            <ol className="breadcrumb">
              <li className="breadcrumb-item">
                <a href="https://lms.iuh.edu.vn/" aria-current="page">Trang chủ</a>
              </li>
            </ol>
          </nav></nav>
                ...
                <div id="month-mini-2021-March-605309f19a446605309f19a4861" className="calendarwrapper" data-courseid={1} data-categoryid={0} data-month={3} data-year={2021} data-view="month">
                  ...
                  <table className="minicalendar calendartable">
                    <caption className="calendar-controls">
                      <h3>
                        <a href="#" title="Tháng này">March 2021</a>
                      </h3>
                    </caption>
                    <thead>
                      <tr>
    ...
    <div id="nav-drawer" data-region="drawer" className="d-print-none moodle-has-zindex closed" aria-hidden="true" tabIndex={-1}>
      <nav className="list-group" aria-label>
